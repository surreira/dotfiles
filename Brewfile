...
brew "skhd", desc: "Simple hotkey-daemon for macOS."
brew "yabai", desc: "A tiling window manager for macOS based on binary space partitioning."
...
tap "nikitabobko/tap"
cask "aerospace", desc: "AeroSpace is an i3-like tiling window manager for macOS"
